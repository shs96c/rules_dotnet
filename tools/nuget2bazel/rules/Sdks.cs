...
namespace nuget2bazel.rules
{
    public abstract class Sdk
    {
        ...
        public Sdk(string internalVersionFolder, string version, string windowsUrl, string linuxUrl, string darwinUrl, string darwinArmUrl, string[] packs = null, bool defaulSdk = false)
        {
            Version = version;
        ...
        public string DarwinArmUrl { get; set; }
        ...
        public string GetDownloadUrl()
        {
            ...
            {
                if (DarwinArmUrl != null && RuntimeInformation.OSArchitecture == Architecture.Arm64)
                {
                    return DarwinArmUrl;
                }
                return DarwinUrl;
    ...
    public static class SdkInfos
    {
        public static Sdk[] Sdks = {
            new SdkCorePost3("3.1.0", "3.1.100",
                ...
                packs: new[] { "Microsoft.NETCore.App.Ref", "Microsoft.AspNetCore.App.Ref", "NETStandard.Library.Ref" }
            ),
            ...
            new SdkCorePost3("6.0.1", "6.0.101",
