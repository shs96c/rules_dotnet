...
%tool% add -p %srcroot%/dotnet/private/deps/gen -b nuget.bzl -c nuget.json -i -l NuGet.PackageManagement 5.11.0
%tool% add -p %srcroot%/dotnet/private/deps/gen -b nuget.bzl -c nuget.json -i -l NuGet.Packaging 5.11.0
%tool% add -p %srcroot%/dotnet/private/deps/gen -b nuget.bzl -c nuget.json -i -l NuGet.Packaging.Core 5.11.0
%tool% add -p %srcroot%/dotnet/private/deps/gen -b nuget.bzl -c nuget.json -i -l NuGet.Protocol 5.11.0
