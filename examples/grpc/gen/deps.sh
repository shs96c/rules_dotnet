...
${TOOL} add -p "${OUTPUT_DIR}" -b nuget.bzl -c nuget.json -i -l  grpc.core 2.28.1
${TOOL} add -p "${OUTPUT_DIR}" -b nuget.bzl -c nuget.json -i -l  grpc.healthcheck 2.28.1
${TOOL} add -p "${OUTPUT_DIR}" -b nuget.bzl -c nuget.json -i -l  google.protobuf 3.12.0-rc1
